...
The one part of this repo that spends real money is the LLM moderator's eval lanes — fired on demand, never on a timer, with a hard pre-flight token ceiling:
