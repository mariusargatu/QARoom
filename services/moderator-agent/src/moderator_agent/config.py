...
class Settings(BaseSettings):
    ...
    # `<provider>:<model>` (ADR-0017/0018). gpt-5-mini is a REASONING model: no seed/temperature;
    ...
    # dated snapshot; the bare `gpt-5-mini` alias would float to the newest snapshot.
    openai_api_key: str = ""
    moderator_model: str = "openai:gpt-5-mini-2025-08-07"
