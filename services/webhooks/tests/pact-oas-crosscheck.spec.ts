 ...
 * webhooks-service is consistent with webhooks-service's PUBLISHED OpenAPI contract. Catches the gap Pact
...
const PACT = resolve(import.meta.dirname, '..', '..', 'gateway', 'pacts', 'gateway-webhooks.json')
